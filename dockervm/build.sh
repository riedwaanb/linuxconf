...
az vm create --name $SERVERNAME -l southafricanorth -g $RESOURCEGROUP --image Canonical:UbuntuServer:18.04-LTS:latest --public-ip-address-dns-name $SERVERNAME --public-ip-address-allocation static --size Standard_B2ms --custom-data cloud-init.yaml --generate-ssh-keys
